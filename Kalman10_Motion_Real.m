...
% filename = 'test_Leap -Leapmotion测试防抖动 - 2\test_Leap\new\' ;  %%  
filename = 'test_Leap -Leapmotion测试防抖动 - 2\实验\' ;  %%  
...
% 速度的 x的误差大概是 1.1311        1.8787     1.8614
% 速度的 y的误差大概是 2.9846        3.7886     3.7022 
% 速度的 z的误差大概是 1.4314        2.1648     2.5209 
...
h = title('$Leap \,\, motion \,\, in \,\, y \,\, direction$') ;  
set(h,'Interpreter','latex') ;
